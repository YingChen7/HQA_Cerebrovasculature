# -*- coding: utf-8 -*-
"""
Created on Thu Oct 21 15:00:46 2021
...
from nnunet.training.ssl import eval_metrices
import copy
from pathlib import Path

DIRNAME = Path(__file__).parents[1].resolve()
WEIGHTSDIR = DIRNAME / "ssl-weights"
            ...
            for phase in ['train', 'val']:
                ...
                for inputs, outputs in self.dataloader[phase]:
                    ...
                    with torch.set_grad_enabled(phase == 'train'):
                        ...
                        # batch_stats: the evaluate metrices
